...
const FilterBar = ({
  ...
  return (
    <div className={`w-full `}>
      ...
      <div
        // className={``}
        className={`flex items-center px-6 py-3 space-x-8  rounded-2xl ${
          darkmode
                              ...
                              >
                                ...
                                >
                                  <div className="flex items-center">
                                    ...
                                    />
                                    <span className="truncate max-w-[10rem] block">
                                      {database}
                                    </span>
                                  </div>
                                  <ChevronRight

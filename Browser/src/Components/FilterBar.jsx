...
const FilterBar = ({
  ...
  return (
    <div className={`w-full `}>
      ...
      <div
        // className={``}
        className={`flex items-center px-6 py-3 space-x-8  rounded-2xl ${darkmode
      ...
      >
                    ...
                    <div key={subject} className="relative">
                      ...
                      >
                        <div className="flex items-center">
                          <Target
                            className={`w-4 h-4 mr-3 flex-shrink-0 ${darkmode ? "text-gray-500" : "text-gray-400"
                              }`}
                          />
                            ...
                            {Object.keys(
                              ...
                              >
                                ...
                                >
                                  <div className="flex items-center">
                                    <Database
                                      className={`w-4 h-4 mr-3 flex-shrink-0 ${darkmode
                                        ? "text-gray-500"
                                        : "text-gray-400"
                                        }`}
                                    />
                                    <span className="truncate max-w-[10rem] block">{database}</span>
        ...
        {user == "admin" && (
          <button
            className={`text-sm flex items-center border-2 border-dashed rounded px-3 py-2 transition-colors ${darkmode

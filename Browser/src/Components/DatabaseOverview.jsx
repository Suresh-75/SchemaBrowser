...
const DatabaseOverview = ({
  ...
  useEffect(() => {
    ...
    setErr("");
    endpoints
      .getSchemaOverview(schemaName)
      .then((res) => {
        setOverview(res.data); // Use the API response directly
        setLoading(false);
      })
      .catch((e) => {
  ...
  return (
    ...
    >
      ...
      <div className="mb-2">
        ...
        <span
          title={
            overview.database_size_bytes
              ? `${overview.database_size_bytes} bytes`
              : ""
          }
        >
            ...
            <tbody>
              {overview.tables.map((t) => (
                ...
                >
                  ...
                  <td className="px-3 py-2">{t.owner}</td> {/* Changed from t.table_owner to t.owner */}
